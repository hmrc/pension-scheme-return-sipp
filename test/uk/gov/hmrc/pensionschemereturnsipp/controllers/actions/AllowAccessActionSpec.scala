...
import uk.gov.hmrc.pensionschemereturnsipp.models.requests.IdentifierRequest
import uk.gov.hmrc.pensionschemereturnsipp.models.requests.IdentifierRequest.{AdministratorRequest, PractitionerRequest}
import uk.gov.hmrc.pensionschemereturnsipp.models.{MinimalDetails, SchemeDetails}
...
class AllowAccessActionSpec extends BaseSpec with ScalaCheckPropertyChecks {
  ...
  lazy val allowAccessAction = new AllowAccessActionProvider(
