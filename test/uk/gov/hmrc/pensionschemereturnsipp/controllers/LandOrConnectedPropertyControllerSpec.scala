...
class LandOrConnectedPropertyControllerSpec extends BaseSpec with TestValues with TestPayloads {
  ...
  private val controller = application.injector.instanceOf[LandOrConnectedPropertyController]
  ...
  "GET LandOrConnectedProperty" must {
    ...
    "return 200 with data" in {
      ...
      when(mockService.getLandOrConnectedProperty(any(), any(), any(), any())(any(), any()))
  ...
  "PUT LandOrConnectedProperty" must {
    ...
    "return 204 with data" in {
      ...
      val result = controller.put(JourneyType.Standard, Some("fbNumber"), None, None)(
        fakePutRequestWithBody(landOrConnectedPartyPayload)
      )
