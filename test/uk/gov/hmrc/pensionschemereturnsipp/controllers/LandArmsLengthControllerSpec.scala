...
import uk.gov.hmrc.pensionschemereturnsipp.models.api.LandOrConnectedPropertyApi.formatRes
import uk.gov.hmrc.pensionschemereturnsipp.models.api.LandOrConnectedPropertyResponse
import uk.gov.hmrc.pensionschemereturnsipp.services.SippPsrSubmissionService
import uk.gov.hmrc.pensionschemereturnsipp.utils.{BaseSpec, TestValues}

import scala.concurrent.{ExecutionContext, Future}

class LandArmsLengthControllerSpec extends BaseSpec with TestValues {
