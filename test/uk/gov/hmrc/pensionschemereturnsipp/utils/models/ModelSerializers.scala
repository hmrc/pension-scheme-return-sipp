...
package uk.gov.hmrc.pensionschemereturnsipp.utils.models
...
import uk.gov.hmrc.pensionschemereturnsipp.models.{IndividualDetails, MinimalDetails, SchemeDetails, SchemeStatus}
