...
import uk.gov.hmrc.pensionschemereturnsipp.connectors.cache.SessionDataCacheConnector
import uk.gov.hmrc.pensionschemereturnsipp.models.cache.PensionSchemeUser.{Administrator, Practitioner}
import uk.gov.hmrc.pensionschemereturnsipp.models.cache.SessionData
