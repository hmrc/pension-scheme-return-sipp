...
package uk.gov.hmrc.pensionschemereturnsipp.controllers.actions

import play.api.mvc.Results.Unauthorized
import play.api.mvc.{ActionFunction, Result}
import uk.gov.hmrc.http.HeaderCarrier
import uk.gov.hmrc.pensionschemereturnsipp.connectors.MinimalDetailsError._
import uk.gov.hmrc.pensionschemereturnsipp.connectors.{
  MinimalDetailsConnector,
  MinimalDetailsError,
  SchemeDetailsConnector
}
import uk.gov.hmrc.pensionschemereturnsipp.models.SchemeId.Srn
import uk.gov.hmrc.pensionschemereturnsipp.models.{MinimalDetails, SchemeDetails, SchemeStatus}
import uk.gov.hmrc.pensionschemereturnsipp.models.SchemeStatus.{Deregistered, Open, WoundUp}
import uk.gov.hmrc.pensionschemereturnsipp.models.requests.{AllowedAccessRequest, IdentifierRequest}
