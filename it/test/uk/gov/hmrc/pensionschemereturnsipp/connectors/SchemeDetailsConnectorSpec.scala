...
import uk.gov.hmrc.pensionschemereturnsipp.Generators.psaIdGen
import uk.gov.hmrc.pensionschemereturnsipp.models.SchemeId.Srn
import uk.gov.hmrc.pensionschemereturnsipp.utils.TestValues

import scala.concurrent.ExecutionContext.Implicits.global

class SchemeDetailsConnectorSpec extends BaseConnectorSpec with TestValues {
  private val psaPspId = "psaPspId"
  private val srn = "S2400000001"
  private val psaId = psaIdGen.sample.value.value
